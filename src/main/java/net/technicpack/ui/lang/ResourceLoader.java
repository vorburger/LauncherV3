...
public class ResourceLoader {
    ...
    public ResourceLoader(LauncherDirectories directories, String... resourcesPath) {
        ...
        StringBuilder dottedResourcePathBuilder = new StringBuilder();
        StringBuilder slashResourcePathBuilder = new StringBuilder();

        for (String pathToken : resourcesPath) {
            dottedResourcePathBuilder.append(pathToken).append(".");
            slashResourcePathBuilder.append("/").append(pathToken);
        }

        dottedResourcePath = dottedResourcePathBuilder.toString();
        slashResourcePath = slashResourcePathBuilder.toString();
